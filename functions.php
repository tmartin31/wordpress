...
function tm31_enqueue_assets()
{
    ...
    // wp_enqueue_style( 'slick', 'https://cdnjs.cloudflare.com/ajax/libs/slick-carousel/1.9.0/slick.min.css', false, '1.9.0' );
    
    wp_enqueue_style( 'app', get_template_directory_uri() . '/style.css', null, time() );

    // JavaScript
    // wp_enqueue_script( 'collapse', 'https://cdn.jsdelivr.net/npm/@alpinejs/collapse@3.x.x/dist/cdn.min.js', array(), '3.x.x', true );
    // wp_enqueue_script( 'intersect', 'https://cdn.jsdelivr.net/npm/@alpinejs/intersect@3.x.x/dist/cdn.min.js', array(), '3.x.x', true );
    // wp_enqueue_script( 'alpine', 'https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js', array(), '3.x.x', true );
    // wp_enqueue_script( 'slick', 'https://cdn.jsdelivr.net/npm/slick-carousel@1.9.0/slick/slick.min.js', array(), '1.9.0', true );
